...
const Profile = () => {
  ...
  const handleUnlikShow = async (movie) => {
  ...
  return (
    <>
      ...
      <div className="relative flex items-center group">
        <MdChevronLeft
          onClick={() => slide(-500)}
          className="bg-white rounded-full absolute left-2 opacity-80 text-gray-700 hidden z-10 
        ...
        <MdChevronRight
          onClick={() => slide(500)}
          className="bg-white rounded-full absolute right-2 opacity-80 text-gray-700 hidden z-10 
        group-hover:block cursor-pointer"
          size={40}
        />
      </div>
